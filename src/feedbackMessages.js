const message = {
    english: {
        ...
        hakikaIncrementAndDecrementMsg: () => "Invalid swap decrement or increment operation",
        ...
        kaziAlreadyExist: (name, scope) => `Kazi with name ${name} already exists within the ${scope} scope`,
    ...
    swahili: {
        ...
        hakikaIncrementAndDecrementMsg: () => "Operesheni ya kuongezea au kupunguazia uliyotumia ni batili",
        ...
        kaziAlreadyExist: (name, scope) => `Kazi yenye jina ${name} tayari ipo ndani ya wigo ${scope}`,
